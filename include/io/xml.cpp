...
std::string XmlDocument::encodeXml(const std::string& str) const {
...
std::string XmlDocument::decodeXml(const std::string& str) const {
    std::string result = str;
    size_t pos = 0;
    while ((pos = result.find("&amp;", pos)) != std::string::npos) {
